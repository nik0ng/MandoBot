...
set CLASSPATH=%APP_HOME%\lib\MandoBot-1.0-SNAPSHOT-all.jar

@rem Execute MandoBot
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MANDO_BOT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MANDO_BOT_EXIT_CONSOLE%" exit 1
exit /b 1
